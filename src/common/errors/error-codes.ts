...
export const ErrorCodes = {
  ...
  BLOG_DRAFTING_NOT_CONFIGURED: 'BLOG_DRAFTING_NOT_CONFIGURED',
  BLOG_DRAFT_GENERATION_FAILED: 'BLOG_DRAFT_GENERATION_FAILED',
  BLOG_DRAFT_INVALID: 'BLOG_DRAFT_INVALID',
  BLOG_TOPIC_RECOMMENDATION_NOT_FOUND: 'BLOG_TOPIC_RECOMMENDATION_NOT_FOUND',
  BLOG_TOPIC_RESEARCH_NOT_CONFIGURED: 'BLOG_TOPIC_RESEARCH_NOT_CONFIGURED',
  BLOG_TOPIC_RESEARCH_FAILED: 'BLOG_TOPIC_RESEARCH_FAILED',
  BLOG_TOPIC_RESEARCH_INVALID: 'BLOG_TOPIC_RESEARCH_INVALID',
