...
export const SEED_TEMPLATE = {
  ...
  schemaJson: {
    ...
    blocks: [
      ...
      { id: 'b7', type: 'repeatingList', label: 'Travel notes', content: '', items: ['Accommodation as listed', 'Daily breakfast', 'Transfers as listed in the itinerary'], align: 'left', spacing: 'normal', emphasis: 'normal', condition: null },
